...
void hw_setup_adc_channels(void) {
    ...
    ADC_RegularChannelConfig(ADC3, ADC_Channel_0, 4, ADC_SampleTime_15Cycles);

    // Injected channels
    ADC_InjectedChannelConfig(ADC1, ADC_Channel_10, 1, ADC_SampleTime_15Cycles);
    ADC_InjectedChannelConfig(ADC2, ADC_Channel_11, 1, ADC_SampleTime_15Cycles);
    ADC_InjectedChannelConfig(ADC3, ADC_Channel_12, 1, ADC_SampleTime_15Cycles);
    ADC_InjectedChannelConfig(ADC2, ADC_Channel_10, 2, ADC_SampleTime_15Cycles);
    ADC_InjectedChannelConfig(ADC3, ADC_Channel_11, 2, ADC_SampleTime_15Cycles);
    ...
    ADC_InjectedChannelConfig(ADC1, ADC_Channel_11, 3, ADC_SampleTime_15Cycles);
